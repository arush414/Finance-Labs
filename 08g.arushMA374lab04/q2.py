...
def plot_q2(x1, y1, x2, y2, x3, y3, x4, y4, x_axis, y_axis, title):
  plt.plot(x1, y1, color = 'Green', label = '3 stocks')
  plt.plot(x2, y2, color = 'Red', label = 'Stock 1 and 2')
  plt.plot(x3, y3, color = 'Blue', label = 'Stock 2 and 3')
  plt.plot(x4, y4, color = 'Orange', label = 'Stock 1 and 3')
  plt.xlabel(x_axis)
  plt.ylabel(y_axis) 
  plt.title(title)
  plt.grid(True)
...
def plot_q2_with_scatter(x1, y1, x2, y2, x3, y3, x4, y4, x5, y5, x_axis, y_axis, title):
  plt.plot(x1, y1, color = 'Green', linewidth = 5, label = '3 stocks')
  plt.plot(x2, y2, color = 'Red', linewidth = 5, label = 'Stock 1 and 2')
  plt.plot(x3, y3, color = 'Blue', linewidth = 5, label = 'Stock 2 and 3')
  plt.plot(x4, y4, color = 'Orange', linewidth = 5, label = 'Stock 1 and 3')
